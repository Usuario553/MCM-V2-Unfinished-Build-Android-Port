...
function onCreate()
	...
	setProperty('table.alpha', 0.00001)
    ...
    setProperty('pixelwall.alpha', 0.00001)
    ...
    setProperty('pixelfloor.alpha', 0.00001)
    ...
    setProperty('pixeltable.alpha', 0.00001)
	...
	setProperty('DeadHallway.alpha', 0.00001)
	...
	setProperty('BF_BODY.alpha', 0.00001)
